...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [673328.268917, 7759584.640683, 674944.705144, 7760958.040585], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32735',
...
map.getView().fit([673328.268917, 7759584.640683, 674944.705144, 7760958.040585], map.getSize());
